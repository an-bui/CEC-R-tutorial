...
You can run code by putting your cursor on the line of code you want to run and hitting command + return (Mac) or control + return (Windows). In this tutorial, you can hit the "Run Code" button to the right hand side at the top of a code box.
...
```{r anemone-jitter, echo = TRUE, exercise = TRUE}
...
### Visualizing model predictions with raw data
